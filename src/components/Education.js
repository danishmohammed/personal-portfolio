...
const Education = () => {
  ...
  return (
    <Element
      name="education"
      className="p-8 bg-gray-100 lg:px-16 min-h-screen flex flex-col items-center"
      id="education"
    >
      <h2 className="text-4xl font-bold mb-8 text-center lg:text-left w-full max-w-6xl lg:mt-16 lg:mb-16 text-black">
      ...
      <div className="relative w-full max-w-6xl lg:pb-16">
        ...
        >
          ...
          <div className="bg-white border border-black p-6 shadow-md rounded-md w-full ml-8 text-left">
            ...
            <p className="mt-2">
              <i>Honours Bachelors of Science Degree candidate, 2022-2026</i>
            </p>
            <p className="mt-1">
              Computer Science Co-op (Specialist in Software Engineering)
            </p>
            <p className="mt-1">
              <u>Relevant courses:</u> Data Structures and Algorithms, Software
              Engineering, Software Tools and Systems Programming,
              Statistics/Data Science, Computer and Network Security, Intro to
              Machine Learning
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-white border border-black p-6 shadow-md rounded-md w-full ml-8 text-left">
            ...
            <p className="mt-2">
              <i>Stanford x DeepLearning.AI Coursera specialization</i>
            </p>
            ...
            <ul className="list-disc list-inside ml-4 mt-1">
              ...
              <li>
                Unsupervised Learning, Recommender Systems, Reinforcement
                Learning
              </li>
            </ul>
          </div>
